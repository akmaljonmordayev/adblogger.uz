...
const STEPS = [
  {
    n: "01", Icon: LuTarget,    color: "#dc2626", bg: "#fef2f2",
    title: "Bloger tanlang",
    desc: "500+ tasdiqlangan bloger ichidan o'z brendingizga mos influencerni kategoriya va auditoriya bo'yicha filtrlang.",
  },
  {
    n: "02", Icon: LuHandshake, color: "#2563eb", bg: "#eff6ff",
    title: "Kelishuv tuzing",
    desc: "Bloger bilan to'g'ridan-to'g'ri muloqot qiling. Shartlarni muvofiqlashtiring va xavfsiz shartnoma imzolang.",
  },
  {
    n: "03", Icon: LuRocket,    color: "#16a34a", bg: "#f0fdf4",
    title: "Natija oling",
    desc: "Kampaniyangiz ishga tushadi. Real vaqtda statistikani kuzating va ROI ni o'lchang.",
  },
];

const BLOGGERS = [
  { name: "Jasur Toshmatov", handle: "@jasur_tech",   cat: "Texnologiya", platform: "YouTube",   followers: "320K", eng: "8.4%",  price: "450 000", g: "135deg,#1e3a5f,#2563eb", init: "JT", pc: "#ff0000" },
  { name: "Malika Rahimova", handle: "@malika_beauty", cat: "Go'zallik",   platform: "Instagram", followers: "180K", eng: "12.1%", price: "280 000", g: "135deg,#831843,#ec4899", init: "MR", pc: "#e1306c" },
  { name: "Bobur Xoliqov",   handle: "@bobur_travel",  cat: "Sayohat",     platform: "Instagram", followers: "95K",  eng: "9.7%",  price: "150 000", g: "135deg,#064e3b,#10b981", init: "BX", pc: "#e1306c" },
  { name: "Zulfiya Nazarova",handle: "@zulfiya_food",  cat: "Ovqat",       platform: "TikTok",    followers: "430K", eng: "15.3%", price: "600 000", g: "135deg,#78350f,#f59e0b", init: "ZN", pc: "#111827" },
];
...
const BLOGS = [
  { tag: "Marketing", tc: "#dc2626", bg: "#fef2f2", title: "Influencer marketing: 2025 trendlari", desc: "Ijtimoiy tarmoqlarda reklama berishning eng so'nggi usullari va samarali strategiyalar.", date: "24 Apr 2025", read: "5 min", grad: "135deg,#7f1d1d,#dc2626" },
  { tag: "Blogerlar", tc: "#2563eb", bg: "#eff6ff", title: "Instagram algoritmini tushuning",       desc: "Reach va engagement oshirish uchun platformaning ishlash mexanizmini batafsil tahlil.",   date: "20 Apr 2025", read: "7 min", grad: "135deg,#1e3a5f,#3b82f6" },
  { tag: "Biznes",    tc: "#7c3aed", bg: "#f5f3ff", title: "ROI ni maksimallashtirish: qo'llanma", desc: "Reklama byudjetingizdan eng katta qaytimni olish uchun 10 ta asosiy strategiya.",         date: "15 Apr 2025", read: "6 min", grad: "135deg,#4c1d95,#7c3aed" },
];
...
const FEATURES = [
  ...
  { Icon: LuCrown,     color: "#7c3aed", bg: "#f5f3ff", border: "#ddd6fe", title: "Premium Blogerlar",   desc: "Faqat tasdiqlangan va sifatli blogerlar platforma da." },
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#f8fafc", overflowX: "hidden" }}>
      ...
      <section style={{ padding: "88px 32px", maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div className="hp-feat-grid" style={{
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h2 style={{ ...S, fontWeight: 800, fontSize: "clamp(28px,4vw,42px)", color: "#0f172a", margin: "0 0 14px", lineHeight: 1.12 }}>
              3 qadamda{" "}
              <span style={{ color: "#2563eb" }}>kampaniyangizni</span> ishga tushiring
            </h2>
          ...
          <div className="hp-steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 24, position: "relative" }}>
            ...
            <div className="hp-connector" style={{
              position: "absolute", top: 60, left: "calc(16.67% + 16px)",
              right: "calc(16.67% + 16px)", height: 1,
              background: "linear-gradient(90deg, #fecaca 0%, #bfdbfe 50%, #bbf7d0 100%)",
              zIndex: 0,
            }} />

            {STEPS.map((s, i) => (
              <div key={i} style={{
                background: "#fff", borderRadius: 24, padding: "38px 32px",
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = `0 24px 56px ${s.color}20`;
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.transform = "none";
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 48, gap: 16, flexWrap: "wrap" }}>
          <div>
            ...
            <h2 style={{ ...S, fontWeight: 800, fontSize: "clamp(26px,3.5vw,38px)", color: "#0f172a", margin: 0, lineHeight: 1.15 }}>
              Eng ta'sirchan<br />
              <span style={{ color: "#dc2626" }}>influencerlar</span>
            </h2>
          </div>
          <Link to={ROUTE_PATHS.BLOGGERS} style={{
            display: "inline-flex", alignItems: "center", gap: 8,
            color: "#fff", fontWeight: 700, fontSize: 13.5,
            background: "linear-gradient(135deg,#dc2626,#b91c1c)",
            textDecoration: "none", padding: "11px 22px", borderRadius: 12,
          ...
          {BLOGGERS.map((b, i) => (
            <div key={i}
              ...
              style={{
                ...
                boxShadow: hoveredBlogger === i ? "0 24px 56px rgba(0,0,0,0.13)" : "0 4px 20px rgba(0,0,0,0.06)",
                transform: hoveredBlogger === i ? "translateY(-8px)" : "none",
            ...
            >
              ...
              <div style={{ height: 86, background: `linear-gradient(${b.g})`, position: "relative" }}>
                ...
                <div style={{
                  ...
                  padding: "3px 8px", borderRadius: 7, border: "1px solid rgba(255,255,255,0.25)",
              ...
              <div style={{ padding: "0 18px", marginTop: -24, position: "relative", zIndex: 1 }}>
                <div style={{
                  ...
                  background: `linear-gradient(${b.g})`,
                  border: "3px solid #fff",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  color: "#fff", fontWeight: 800, fontSize: 15,
                  boxShadow: "0 4px 14px rgba(0,0,0,0.18)", ...S,
                }}>{b.init}</div>
              </div>
              ...
              <div style={{ padding: "10px 18px 0" }}>
                ...
                <span style={{
                  ...
                  marginTop: 9, background: "#f8fafc",
                  color: "#475569", fontSize: 11, fontWeight: 600,
                  padding: "3px 10px", borderRadius: 7, border: "1px solid #f1f5f9",
                }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, padding: "14px 18px" }}>
                {[
                  ...
                  <div key={j} style={{
                    background: "#f8fafc", borderRadius: 11, padding: "9px 11px",
                    border: "1px solid #f1f5f9",
                  }}>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ ...S, fontWeight: 800, fontSize: 16, color: "#0f172a", marginTop: 2 }}>
                    {b.price} <span style={{ fontSize: 10, color: "#94a3b8", fontWeight: 500 }}>so'm</span>
                  </div>
                </div>
                <Link to={ROUTE_PATHS.BLOGGERS} style={{
                  background: "linear-gradient(135deg,#dc2626,#b91c1c)",
      ...
      <section style={{
        ...
        borderBottom: "1px solid #f1f5f9", padding: "72px 32px",
      }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 style={{ ...S, fontWeight: 800, fontSize: "clamp(26px,3.5vw,38px)", color: "#0f172a", margin: "0 0 12px", lineHeight: 1.15 }}>
              ...
              <span style={{ color: "#0891b2" }}>blogerlar bor</span>
            </h2>
          ...
          <div className="hp-platforms-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 18 }}>
            {PLATFORMS.map((p, i) => (
              <div key={i} style={{
                background: p.bg, borderRadius: 22, padding: "34px 24px",
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.boxShadow = `0 20px 48px ${p.color}20`;
      ...
      <section style={{
        ...
        {/* Glow blobs */}
        {[
          { top: "-120px", left: "-120px", color: "rgba(220,38,38,0.12)" },
          { bottom: "-80px", right: "-80px", color: "rgba(124,58,237,0.1)" },
        ].map((g, i) => (
          <div key={i} style={{
            position: "absolute", width: 500, height: 500, borderRadius: "50%",
            background: g.color, filter: "blur(90px)", pointerEvents: "none",
            ...
            <div key={i} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  color: "#fff", fontWeight: 800, fontSize: 14, flexShrink: 0, ...S,
                }}>{t.init}</div>
                <div>
                ...
                <div style={{ marginLeft: "auto", display: "flex", gap: 3 }}>
                  {Array.from({ length: t.stars }).map((_, j) => (
                    <LuStar key={j} size={14} fill="#fbbf24" color="#fbbf24" />
                  ))}
                </div>
              </div>
            </div>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 8, marginTop: 28 }}>
            {TESTIMONIALS.map((t, i) => (
              <button key={i} onClick={() => setActiveT(i)} style={{
                ...
                transition: "all .3s",
                width: i === activeT ? 36 : 14,
                background: i === activeT ? t.color : "rgba(255,255,255,0.2)",
                boxShadow: i === activeT ? `0 0 12px ${t.color}80` : "none",
              }} />
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "88px 32px", maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 48, gap: 16, flexWrap: "wrap" }}>
          <div>
            ...
            <h2 style={{ ...S, fontWeight: 800, fontSize: "clamp(26px,3.5vw,38px)", color: "#0f172a", margin: 0, lineHeight: 1.15 }}>
              Eng so'nggi{" "}
              <span style={{ color: "#16a34a" }}>maqolalar</span>
            </h2>
          </div>
          <Link to={ROUTE_PATHS.BLOGS} style={{
            display: "inline-flex", alignItems: "center", gap: 8,
            color: "#16a34a", fontWeight: 700, fontSize: 13.5,
            textDecoration: "none", padding: "11px 22px", borderRadius: 12,
        ...
        <div className="hp-blogs-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 22 }}>
          {BLOGS.map((b, i) => (
            <Link key={i} to={ROUTE_PATHS.BLOGS}
              ...
              style={{
                ...
                background: "#fff", borderRadius: 22, overflow: "hidden",
                border: "1px solid #f1f5f9",
                boxShadow: hoveredBlog === i ? "0 24px 56px rgba(0,0,0,0.1)" : "0 4px 20px rgba(0,0,0,0.05)",
                transform: hoveredBlog === i ? "translateY(-8px)" : "none",
                transition: "transform .3s, box-shadow .3s",
              }}
            >
              {/* Cover */}
              <div style={{
                height: 148, background: `linear-gradient(${b.grad})`,
              ...
              <div style={{ padding: "22px 22px 24px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                  <span style={{
                    background: b.bg, color: b.tc,
                    fontSize: 10, fontWeight: 700, padding: "3px 9px",
                    borderRadius: 7, border: `1px solid ${b.tc}25`,
                  }}>{b.tag}</span>
                ...
                <div style={{
                  ...
                  fontSize: 12.5, color: b.tc, fontWeight: 700,
                }}>
      ...
      <section style={{
        background: "#fff", borderTop: "1px solid #f1f5f9",
        borderBottom: "1px solid #f1f5f9", padding: "28px 32px",
      }}>
        <div style={{
      ...
      <section style={{ padding: "88px 32px", maxWidth: 1280, margin: "0 auto" }}>
        <div style={{
          ...
          {/* Ring decorations */}
          {[
            { size: 600, right: "-160px", top: "50%", mt: "-300px" },
            { size: 380, right: "-40px",  top: "50%", mt: "-190px" },
          ].map((r, i) => (
            <div key={i} style={{
              position: "absolute", borderRadius: "50%", pointerEvents: "none",
              width: r.size, height: r.size,
              right: r.right, top: r.top, marginTop: r.mt,
          ...
          <div style={{
            ...
            borderRadius: "50%", left: "-200px", bottom: "-250px",
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <div style={{
              ...
              letterSpacing: "2.5px", color: "#fbbf24", textTransform: "uppercase",
              marginBottom: 24,
            }}>
            ...
            <h2 style={{ ...S, fontWeight: 800, fontSize: "clamp(28px,4.5vw,48px)", color: "#fff", margin: "0 0 18px", lineHeight: 1.1 }}>
              ...
              <span style={{
                ...
                WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
              }}>bloger topishga tayyormisiz?</span>
            </h2>
            ...
            <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
              <Link to={ROUTE_PATHS.BLOGGERS} style={{
                ...
                fontWeight: 800, fontSize: 15.5, padding: "15px 36px",
              ...
              >
                Blogerlarni ko'rish <LuArrowRight size={17} />
              </Link>

              <Link to={ROUTE_PATHS.BLOGER_BOLISH} style={{
                display: "inline-flex", alignItems: "center", gap: 9,
