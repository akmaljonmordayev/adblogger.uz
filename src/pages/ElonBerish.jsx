...
const DURATIONS = [
  "1 hafta", "2 hafta", "1 oy", "2–3 oy", "6 oy", "1 yil",
];
...
/* ── Blogger form ── */
function BloggerForm({ onSubmit }) {
  const [form, setForm] = useState({
    name: "", phone: "", instagram: "", youtube: "", telegram: "",
    platforms: [], services: [], niche: [], followers: "",
    pricePost: "", priceStory: "", priceVideo: "",
    portfolio: "", about: "",
  });
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div>
        <div style={{
          ...
          textTransform: "uppercase", color: "#dc2626", marginBottom: 16,
        }}>
          Shaxsiy ma'lumotlar
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginTop: 14 }}>
          {form.platforms.includes("instagram") && (
            <Field label="Instagram">
              <input style={INP} placeholder="@username" value={form.instagram}
                onChange={e => set("instagram", e.target.value)} onFocus={FOCUS} onBlur={BLUR} />
            </Field>
          )}
          {form.platforms.includes("youtube") && (
            <Field label="YouTube kanal">
              <input style={INP} placeholder="Kanal nomi" value={form.youtube}
                onChange={e => set("youtube", e.target.value)} onFocus={FOCUS} onBlur={BLUR} />
            </Field>
          )}
          {form.platforms.includes("telegram") && (
            <Field label="Telegram kanal">
              <input style={INP} placeholder="@kanal" value={form.telegram}
                onChange={e => set("telegram", e.target.value)} onFocus={FOCUS} onBlur={BLUR} />
            </Field>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <Field label="Rasm / Screenshoot" hint="(ixtiyoriy)">
            <div style={{
              height: 100, border: "2px dashed #e5e7eb", borderRadius: 12,
              display: "flex", flexDirection: "column",
              alignItems: "center", justifyContent: "center",
              gap: 6, cursor: "pointer", background: "#fafafa",
              transition: "border-color 0.2s",
            }}
              onMouseEnter={e => e.currentTarget.style.borderColor = "#dc2626"}
              onMouseLeave={e => e.currentTarget.style.borderColor = "#e5e7eb"}
            >
              <LuImage size={22} style={{ color: "#9ca3af" }} />
      ...
      <button
        onClick={() => {
          if (form.name && form.phone && form.platforms.length) onSubmit();
        }}
        style={{
...
function BusinessForm({ onSubmit }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <button
        onClick={() => {
          if (form.companyName && form.phone && form.product) onSubmit();
        }}
        style={{
          padding: "14px", borderRadius: 12,
...
export default function ElonBerish() {
  ...
  const [type, setType] = useState(null); // "blogger" | "business"
  ...
  if (submitted) return (
    <div style={{
      ...
      <h2 style={{
        ...
        fontSize: 26, fontWeight: 800, color: "#111827", marginBottom: 10,
      }}>
        ...
        {[1, 2].map(s => (
          <div key={s} style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{
              ...
              background: step >= s ? "#dc2626" : "#f3f4f6",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          ...
          <button
            ...
            onMouseEnter={e => {
              ...
              e.currentTarget.style.boxShadow = "0 8px 32px rgba(220,38,38,0.12)";
          ...
          >
            ...
            <div>
              <div style={{
                fontFamily: "'Syne', sans-serif",
                fontSize: 19, fontWeight: 800, color: "#111827", marginBottom: 8,
              }}>
                Men blogeriman
              </div>
      ...
      {step === 2 && (
        <div style={{
          ...
          <div style={{
            ...
            padding: "8px 16px", borderRadius: 12, marginBottom: 28,
            background: type === "blogger" ? "#fef2f2" : "#eff6ff",
            border: `1.5px solid ${type === "blogger" ? "#fecaca" : "#bfdbfe"}`,
          }}>
            {type === "blogger"
            ...
            <span style={{
              ...
              color: type === "blogger" ? "#dc2626" : "#2563eb",
            }}>
          ...
          {type === "blogger"
            ? <BloggerForm onSubmit={() => setSubmitted(true)} />
            : <BusinessForm onSubmit={() => setSubmitted(true)} />
          }
        </div>
      )}
    </div>
