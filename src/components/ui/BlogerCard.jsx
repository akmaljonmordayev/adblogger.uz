...
const Icons = {
  ...
  Sports: <svg className="w-3.5 h-3.5 mr-1" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zm-.707-13.707a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L12 7.414l-2.707 2.707a1 1 0 01-1.414-1.414l3-3z"/></svg>,
  Telegram: <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 24 24"><path d="M9.04 15.47l-.39 3.73c.56 0 .8-.24 1.08-.52l2.6-2.47 5.39 3.94c.99.55 1.7.26 1.97-.91l3.57-16.73.01-.01c.32-1.48-.53-2.06-1.5-1.7L1.52 9.27c-1.43.56-1.41 1.36-.24 1.72l5.6 1.75L19.4 4.5c.59-.39 1.13-.17.69.22"/> </svg>,
