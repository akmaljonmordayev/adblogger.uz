...
const Icons = {
  ...
  Instagram: <svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>,
  YouTube:   <svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>,
  Telegram:  <svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><path d="M9.04 15.47l-.39 3.73c.56 0 .8-.24 1.08-.52l2.6-2.47 5.39 3.94c.99.55 1.7.26 1.97-.91l3.57-16.73.01-.01c.32-1.48-.53-2.06-1.5-1.7L1.52 9.27c-1.43.56-1.41 1.36-.24 1.72l5.6 1.75L19.4 4.5c.59-.39 1.13-.17.69.22"/></svg>,
...
function StarRating({ value }) {
  const rounded = Math.round(value * 2) / 2; // 0.5 step
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
      {[1, 2, 3, 4, 5].map(i => {
        ...
        return (
          <span key={i} style={{ color: full || half ? "#f59e0b" : "#e2e8f0", display: "flex" }}>
            <svg width="11" height="11" viewBox="0 0 24 24" fill={full ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2">
              {half ? (
                <>
                  <defs>
                    <clipPath id={`h${i}`}><rect x="0" y="0" width="12" height="24"/></clipPath>
                  </defs>
                  <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" fill="none" stroke="#e2e8f0"/>
                  <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" fill="#f59e0b" clipPath={`url(#h${i})`} stroke="none"/>
                </>
              ) : (
                <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
              )}
      ...
      <span style={{ fontSize: 10, fontWeight: 700, color: "#64748b", marginLeft: 1 }}>
...
const BloggerCard = ({
  ...
  const platforms = allPlatforms?.length ? allPlatforms : [platform];
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            {platforms.map((p, idx) => {
              const badge = platformBadge[p] ?? { bg: "#64748b", text: "#fff" };
              const isFirst = idx === 0;
              return (
                <div key={p} style={{
                  display: "flex", alignItems: "center", gap: isFirst ? 5 : 4,
                  background: badge.bg, color: badge.text,
                  fontSize: 10, fontWeight: 700,
                  padding: isFirst ? "4px 10px" : "4px 8px",
                  borderRadius: 20,
