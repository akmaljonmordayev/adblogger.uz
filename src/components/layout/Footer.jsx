...
function SocialBtn({ href, label, color = "yellow", target, rel, children }) {
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className={revealClass("delay-0")}>
          ...
          <div className="flex gap-2 mt-4">
            ...
            <SocialBtn href="https://www.instagram.com/adblogger.uz?igsh=MXEwcW9yYnd4bGxq&utm_source=qr" label="Instagram" color="yellow" target="_blank" rel="noopener noreferrer">
              <svg fill="currentColor" viewBox="0 0 24 24">
            ...
            <SocialBtn href="https://www.youtube.com/@adbloggeruz" label="YouTube" color="red" target="_blank" rel="noopener noreferrer">
              <svg fill="currentColor" viewBox="0 0 24 24">
