...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      {/* Asosiy Karta */}
      <div className="relative z-10 w-full max-w-[900px] bg-white/5 backdrop-blur-[30px] border border-white/10 rounded-[28px] md:rounded-[40px] shadow-2xl flex flex-row overflow-hidden">

        {/* Chap tomon: Form qismi */}
        <div className="flex-1 min-w-0 p-6 sm:p-10 md:p-14 flex flex-col justify-center">
          <div className="mb-8 md:mb-10">
            ...
            <p className="text-slate-400 text-xs sm:text-sm">Xush kelibsiz! Boshqaruv tizimiga kiring.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-transparent border-b-2 border-slate-800 py-3 pl-10 text-white outline-none focus:border-blue-500 transition-all placeholder:text-slate-600 text-sm sm:text-base"
                value={email}
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-transparent border-b-2 border-slate-800 py-3 pl-10 pr-10 text-white outline-none focus:border-red-500 transition-all placeholder:text-slate-600 text-sm sm:text-base"
                value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative group overflow-hidden bg-gradient-to-r from-blue-600 to-red-600 p-4 rounded-2xl text-white font-bold text-base sm:text-lg hover:shadow-[0_0_30px_rgba(37,99,235,0.4)] transition-all active:scale-95 disabled:opacity-50"
            >
        ...
        {/* O'ng tomon: Neon effektlar — faqat md+ ekranlarda */}
        <div className="hidden md:flex flex-1 bg-black/40 relative items-center justify-center overflow-hidden border-l border-white/5">
