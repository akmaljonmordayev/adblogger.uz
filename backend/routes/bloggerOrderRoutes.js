...
router.patch('/:orderId/sign',                    protect, ctrl.signContract);
router.patch('/:orderId/contract',                protect, ctrl.updateContract);
router.patch('/:orderId/cancel',                  protect, ctrl.cancelContract);
